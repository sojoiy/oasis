			...
			<div class="kt-portlet kt-portlet--mobile">
				...
				<div class="card-body">
					...
					<div class="kt-form kt-form--label-right kt-margin-t-20 kt-margin-b-10">
						<form method="post" id="changerStatutForm" action="/admin/prestataires">
							{{ csrf_field() }}
										...
										<div class="col-md-4 kt-margin-b-20-tablet-and-mobile">
											<div class="kt-form__group kt-form__group--inline">
												...
												<div class="kt-form__control">
													<select class="form-control bootstrap-select" name="statut" onchange="$('#changerStatutForm').submit()" id="kt_form_status">
...
@section('specifijs')
	...
	<script src="{{ asset('assets/js/datatables/listepresta.js') }}" type="text/javascript"></script>
@endsection