	...
	<div class="row">
		<div class="col-md-6">
			<div class="kt-portlet">
				...
				<form class="kt-form" method="POST" action="/chantier/saveaction" enctype="multipart/form-data">
					<div class="card-body">
						...
						@else
							...
							<div class="form-group" id="info_cloture">
								<button type="button" onclick="terminer({{ $action->id }})" class="btn btn-success"><i class="fa fa-check-circle"></i> Marquer comme terminée</button>
							</div>
						@endif
					</div>
				</form>
		...
		<div class="col-md-6">
			@foreach($documents as $document)
				<div class="kt-portlet" id="justificatif_{{ $document->id }}">
					...
					<div class="card-body">
							<div class="form-group" id="info_cloture">
								<a href="#" class="btn btn-sm btn-success"><i class="fa fa-download"></i>Télécharger</a>
			...
			<div class="kt-portlet">
				...
				<form class="kt-form" method="POST" action="/chantier/chargerjustificatif" enctype="multipart/form-data">
					<div class="card-body">
						<input type="hidden" name="action" value="{{ $action->id}}" />
						{{ csrf_field() }}
