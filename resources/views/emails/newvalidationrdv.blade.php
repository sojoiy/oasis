			...
			<table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
				<tbody>
						...
						<td style="word-wrap:break-word;font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-bottom:0px;" align="left">
							<div style="cursor:auto;color:#55575d;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;">
								<h1 style="font-size: 20px; font-weight: bold; text-align: center;">
									<span style="font-family:Helvetica,Arial,sans-serif">Demande de validation de rendez vous
								</h1>
							</div>
						</td>
					</tr>
					<tr>
						<td style="word-wrap:break-word;font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-bottom:0px;" align="left">
							<div style="cursor:auto;color:#55575d;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;">
								<p style="font-size: 13px; margin: 10px 0;">Rendez vous de {{ $rendezvous->nom_visiteur }} {{ $rendezvous->prenom_visiteur }} par {{ $rendezvous->nom_do }} {{ $rendezvous->prenom_do }}.</p>
	  							<p>Rendez vous prévu le {{ $rendezvous->date_rdv }}.</p>
	  						</div>
						</td>
					</tr>
				</tbody>
