			...
			<table role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
				<tbody>
						...
						<td style="word-wrap:break-word;font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-bottom:0px;" align="left">
							<div style="cursor:auto;color:#55575d;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;">
								<h1 style="font-size: 20px; font-weight: bold; text-align: center;">
									<span style="font-family:Helvetica,Arial,sans-serif">Nouveau compte
								</h1>
							</div>
						</td>
					</tr>
					<tr>
						<td style="word-wrap:break-word;font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-bottom:0px;" align="left">
							<div style="cursor:auto;color:#55575d;font-family:Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;">
								<p style="font-size: 13px; margin: 10px 0;">Vous avez été invité à rejoindre la plateforme Oasis. Voici vos identifiants :<br>- Identifiant : <b>{{ $user->email }}</b><br>- Mot de pase : <b>{{ $user->fonction }}</b></p>
	  							<p>Connectez-vous à votre espace à l'adresse http://recette.oasis-dev.pro avec vos identifiants.</p>
	  						</div>
						</td>
					</tr>
				</tbody>
