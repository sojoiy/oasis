...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
	<div class="kt-subheader__main">
		<h3 class="kt-subheader__title">Pièces</h3>
			...
			<div class="card card-custom">
				<div class="card-body">
					...
					<form class="kt-form" method="POST" action="/parametres/savetypepiece">
						<input type="hidden" name="id" value="{{ $typePiece->id }}" />
						{{ csrf_field() }}
						<div class="card-body">
							<div class="kt-section kt-section--first">
								...
								<div class="form-group row">
									<label class="col-3 col-form-label">Livreur :</label>
									<div class="col-3">
										<span class="kt-switch">
											<label>
												<input type="checkbox" {{ $typePiece->livreur ? 'checked' : '' }} name="livreur" />
												<span></span>
											</label>
										</span>
									</div>
								...
								<div class="form-group row">
									<label class="col-3 col-form-label">Livraison :</label>
									<div class="col-3">
										<span class="kt-switch">
											<label>
												<input type="checkbox" {{ $typePiece->livraison ? 'checked' : '' }} name="livraison" />
												<span></span>
											</label>
										</span>
									</div>
