...
var KTInputmask = function () {
    ...
    var demos = function () {
        ...
        // repeating mask
        $("#sjy_inputmask_tva").inputmask({
            "mask": "AA 99999999999",
            "greedy": false
        }); // ~ mask "9" or mask "99" or ... mask "9999999999"
        
		// repeating mask
        $("#sjy_inputmask_hour").inputmask({
            "mask": "99:99",
            "greedy": false
        }); // ~ mask "9" or mask "99" or ... mask "9999999999"
		...
		$("#phone_number2").inputmask({
            "mask": "99 99 99 99 99 99 99 99",
            "greedy": false
        }); // ~ mask "9" or mask "99" or ... mask "9999999999"
		
		$("#phone_number3").inputmask({
            "mask": "99 99 99 99 99 99 99 99",
            "greedy": false
        }); // ~ mask "9" or mask "99" or ... mask "9999999999"
		
        // // repeating mask
        $("#sjy_inputmask_siret").inputmask({
            "mask": "999 999 999 99999",
            "greedy": false
        }); // ~ mask "9" or mask "99" or ... mask "9999999999"
		
        // // repeating mask
        $("#sonNoSiret").inputmask({
            "mask": "999 999 999 99999",
            "greedy": false
        }); // ~ mask "9" or mask "99" or ... mask "9999999999"
